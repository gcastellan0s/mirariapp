...
if DJANGO_SETTINGS_MODULE == 'config.settings.production':
    ...
    env.read_env(str(ROOT_DIR.path('.envs/.production/.postgres')))
else:
...
AUTH_USER_MODEL = 'mirari.User'
# https://docs.djangoproject.com/en/dev/ref/settings/#login-redirect-url
LOGIN_REDIRECT_URL = 'mirari:login__Organization__TemplateView'
# https://docs.djangoproject.com/en/dev/ref/settings/#login-url
LOGIN_URL = 'mirari:login__Organization__TemplateView'
...
ADMINS = [
    ("""Gustavo Castellanos""", 'g@mirari.xyz'),
]
...
## https://django-allauth.readthedocs.io/en/latest/configuration.html
#ACCOUNT_ADAPTER = 'mirari.users.adapters.AccountAdapter'
## https://django-allauth.readthedocs.io/en/latest/configuration.html
#SOCIALACCOUNT_ADAPTER = 'mirari.users.adapters.SocialAccountAdapter'
