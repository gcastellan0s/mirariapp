	...
	def dispatch(self, request, *args, **kwargs):
		...
		if request.method == 'POST':
			if request.GET.get('api') == 'getTablaAmortizacion':
				ids = ('17782001','17170032','17170033','17848001','17854001','17860001','17170036','17170037','17577002','17910001','17901001','17765008','17765009','17170038','17170039','17456007','17917017','17731008','17917019','17917020','17917021','17964003','17917022','17917023','17917024','17917025','17917026','17202653','17917027','17917028','17917029','17944044','17917030','17854002','17917031','17944047','17944048','17944049','17944050','17944051','17944052','17944053','17944054','17944055',)
				try:
					import cx_Oracle
					db = DBConnection.objects.filter(name='siebel', organization__pk=self.request.session.get('organization')).first()
					con = cx_Oracle.connect(db.db_name+'/'+db.db_password+'@'+db.db_host+'/'+db.db_user, encoding = "UTF-8", nencoding = "UTF-8")
