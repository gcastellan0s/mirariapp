...
urlpatterns = [
	...
	path('api/ChangeOrganizationApiView/<slug:app>/<slug:action>/<slug:model>/', ChangeOrganization__ApiView.as_view(), name='ChangeOrganization__ApiView'),
	...
	path('gupdate/<slug:app>/<int:pk>/<slug:model>/', Generic__UpdateView.as_view(), name='Generic__UpdateView'),
	path('gdelete/<slug:app>/<int:pk>/<slug:model>/', Generic__DeleteView.as_view(), name='Generic__DeleteView'),
