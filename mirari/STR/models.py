...
VARS = {
    ...
    'FORM': [
        ...
        TabHolder(
            ...
            Tab('EXTRA',
                HTML('<h4 class="kt-section__title ml-2 mb-4">INFORMACIÓN EXTRA</h4>'),
            ...
            Tab('REPORTE',
                ...
                HTML("""<div class="kt-widget6">
                        ...
                        <div class="kt-widget6__body">
                            <div class="kt-widget6__item" v-for="product in productsReport" v-bind:style="product.inventoryorder.operationType === 'out' ?  { background-color: #ff000014; } : { background-color: #00ff0714; }">
