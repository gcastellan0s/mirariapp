...
export default function () {
  return {
    ...
    M:{
      ...
      SLOGAN: require('@/../../package.json').slogan,
      DOMAIN: require('@/../../package.json').domain,
      CODE: require('@/../../package.json').code,
      LOGO: require('@/../../package.json').logo,
      LOGOBG: require('@/../../package.json').logobg,
      API: '//'+require('@/../../package.json').api,
    },
